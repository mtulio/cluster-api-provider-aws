...
func (in *AdditionalListenerSpec) DeepCopyInto(out *AdditionalListenerSpec) {
	*out = *in
	if in.TargetHealthCheck != nil {
		in, out := &in.TargetHealthCheck, &out.TargetHealthCheck
		*out = new(AdditionalTargetGroupHealthCheck)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdditionalTargetGroupHealthCheck) DeepCopyInto(out *AdditionalTargetGroupHealthCheck) {
	*out = *in
	if in.Path != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalTargetGroupHealthCheck.
func (in *AdditionalTargetGroupHealthCheck) DeepCopy() *AdditionalTargetGroupHealthCheck {
	if in == nil {
		return nil
	}
	out := new(AdditionalTargetGroupHealthCheck)
