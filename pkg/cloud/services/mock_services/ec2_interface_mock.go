...
func (m *MockEC2Interface) ReconcileElasticIPFromPublicPool(arg0 *v1beta2.Instance) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileElasticIPFromPublicPool", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReconcileElasticIPFromPublicPool indicates an expected call of ReconcileElasticIPFromPublicPool.
func (mr *MockEC2InterfaceMockRecorder) ReconcileElasticIPFromPublicPool(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileElasticIPFromPublicPool", reflect.TypeOf((*MockEC2Interface)(nil).ReconcileElasticIPFromPublicPool), arg0)
}
